...
import emailSerivice from '../services/emailService'
    ...
    return new Promise(async (resolve,reject) =>{
        try{
            if(!doctorId || !date){
                ...
                console.log('check data', doctorId);
                ...
                let data = await db.Booking.findAll({
                    ...
                    include:[
                        ...
                        {
                            model:db.Allcode, as:'timeTypeDatePatient', attributes:['valueEn','valueVi']
                        }
                    ],
                    raw: false,
                    nest: true,
    ...
    return new Promise(async(resolve,reject)=>{
        try{
            if(!data.email || !data.doctorId || !data.patientId || !data.timeType || !data.imgBase64){
                ...
                await emailSerivice.sendAttachmentService(data);
                resolve({
                    errCode: 0,
                    errMessage:'OK'
                })
...
module.exports = {
    ...
    getListPatientForDoctorService: getListPatientForDoctor,
    sendRemedyService: sendRemedy
}